...
1. 记录数据库连接的属性 `yii2.0\basic\vendor\yiisoft\yii2\db\Connection.php`
...
2. `Users::className();` 获取model的class
...
//vendor\animal 这个目录下
<?php
namespace vendor\animal; //注意这里的命名空间
