...
$city = new PDO('mysql:host=localhost;dbname=yiitest;prot=3306;charset=utf8','root','mcy');
$resCity = $city -> query('select id,name,parent_id from tbl_region where level = 2');
$resCounty = $city -> query('select id,name,parent_id from tbl_region where level = 3');
$arr2 = $resCity ->fetchAll(PDO::FETCH_ASSOC);
$arr3 = $resCounty ->fetchAll(PDO::FETCH_ASSOC);
